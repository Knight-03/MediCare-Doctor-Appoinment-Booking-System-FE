...
import uploadImagedToCloudinary from "../utils/uploadCloudinary";
...
function Signup() {
  ...
  const handleFileInputChange = async (e) => {
    // we have used zcloudinary to upload images
    const file = e.target.files[0];
    const data = await uploadImagedToCloudinary(file);
    ...
    <section className="px-5 xl:px-0">
      <div className="max-w-[1170px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounde-l-lg lg:pl-16 py-10">
